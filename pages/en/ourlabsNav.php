...
<div class="navbar navbarLab navPosition">
    ...
    <div class="nav-content" id="nav-content">
        ...
        <a href="?page=pages/en/equipment#3dprint">3D Printing Lab</a>
        <a href="?page=pages/en/equipment#electronic">Electronic Lab</a>
        <a href="https://n00bs.fablab.ba">IT Lab</a>
        <a href="https://bio.fablab.ba/" target="_blank">3d Bio Lab</a>
        <a href="?page=pages/en/equipment#drone">Drone Lab</a>
        <a href="?page=pages/en/equipment#ar">AR/VR lab</a>
        <a href="?page=pages/en/equipment#ai">AI Lab</a>
