...
<!-- End Facebook Pixel Code -->
  ...
  <!-- navigation -->
  <div class="navbar navbarPartnerhip navPosition">
    <div class="nav-head">
      <img class="homeeSupport navLogo" src="../../slike/logo.png">
    ...
    <div class="nav-content" id="nav-content">
      ...
      <a href="?page=pages/en/support">Support Us</a>
      <a href="?page=pages/en/support#strateg">Strategic partners</a>
      <a href="?page=pages/en/support#partners">Partners</a>
      <a href="?page=pages/en/support#friends">Friends of fab</a>
      <a href="?page=pages/en/support#chapters">Chapters</a>
      <a href="?page=pages/en/support#networks">Networks</a>
      <a href="?page=pages/en/donate">Donate</a>
      <a href="?page=pages/en/partnership">Become Partner</a>
	 <span class="lanFlags">
