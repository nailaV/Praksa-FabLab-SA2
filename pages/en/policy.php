...
<div class="w3-container" id="conferences" style="margin-top:5%">
  <h1 class="w3-xxxlarge w3-text-grey">Privacy Policy <small><a href="./index.php"> <i class="fas fa-home"></i></a></small> </h1> 
  <hr style="width:80%;border:4px solid grey" class="w3-round"> 
</div>
  <div class="w3-row-padding "><div class="w3-container style4" id="privacy">
  ...
  <div class="w3-threequarter">
    <div class="w3-card">
      <div class="w3-container">
        <p class="style5">The privacy policy </p>
...
<p>When contacting us on our site, as appropriate, you may be asked to enter your name, email address, User IDs or other details to help you with your experience. </p>
<p>When do we collect information? </p>
<p>We collect information from you when you contact us on our site, fill out a form, or enter information on our site. </p>
<p>How do we use your information? </p>
<p>We may use the information we collect from you when you contact us, sign up for our newsletter, respond to a survey or marketing communication, surf the website, or use certain other site features in the following ways: </p>
...
<p>We, along with third-party vendors such as Google use first-party cookies (such as the Google Analytics cookies) and third-party cookies (such as the DoubleClick cookie) or other third-party identifiers together <br>
  Collect statistics to improve our service and customer experience </p>
<p>Opting out: <br>
...
<p>Storage of data </p>
<p>We store all data on dedicated servers which are physically located and locked into a secured area. No data is saved in the cloud. </p>
<p>Contacting Us </p>
<p>If there are any questions regarding this privacy policy, you may contact us using the information below. </p>
<p>Uduzenje Fablab <br> 
  Fablab.ba
</p>
<p>Address</p>
<p>Zmaja od Bosne 8, University of Sarajevo Campus <br>
  71000 Sarajevo <br>
  Bosnia and Herzegovina </p>
<p><a href="mailto:info@bsip.ba">info@fablab.ba</a></p>
<p></p>
<p></p>
      </div>
    </div>
