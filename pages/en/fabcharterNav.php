...
<!-- navigation -->
<div class="navbar navbarAbout" style="position: sticky; top: 0; z-index: 10">
  <div class="nav-head">
    <img class="homeeA navLogo" src="../../slike/logo.png" style="float: left;height:52px;">
  ...
  <div class="nav-content" id="nav-content">
    ...
    <a href="?page=pages/en/about#association">About us</a>
    <a href="?page=pages/en/about#mission">Mission and Vission</a>
    <a href="?page=pages/en/firstfab">First Fab in BiH</a>
    <a href="?page=pages/en/fabcharter">Fab Charter</a>
    <!-- <a href="declarations.php">Declarations</a> -->
	    <span class="lanFlags">
