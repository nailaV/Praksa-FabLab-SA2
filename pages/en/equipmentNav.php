...
<div class="navbar navbarLab navPosition">
  ...
  <div class="nav-content" id="nav-content">
    ...
    <a href="?page=pages/en/ourlabs#about">About Our Labs</a>
    <a href="?page=pages/en/ourlabs#3dprint">3D Print Lab</a>
    <a href="?page=pages/en/ourlabs#electronic">Electronic Lab</a>
    <a href="https://n00bs.fablab.ba" target="_blank">IT Lab</a>
    <a href="https://bio.fablab.ba/" target="_blank">3d Bio Lab</a>
    <a href="?page=pages/en/ourlabs#droneLab">Drone Lab</a>
    <a href="?page=pages/en/ourlabs#arvr">AR/VR lab</a>
    <a href="?page=pages/en/ourlabs#ai">AI Lab</a>
    <a href="?page=pages/en/equipment">Equipment</a>
	        <span class="lanFlags">
