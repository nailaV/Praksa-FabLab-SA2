...
<!-- End Facebook Pixel Code -->
  ...
  <!-- navigation -->
  <div class="navbar navbarTeam navPosition">
    <div class="nav-head">
      <img class="homeeTeam navLogo" src="../../slike/logo.png">
    ...
    <div class="nav-content" id="nav-content">
      ...
      <a href="?page=pages/bhs/podrska">Podrška</a>
      ...
      <a href="#" style="color: #E60000;font-weight: bolder;">Live</a>
		  <span class="lanFlags">
  ...
  <span class="lanFlagsDesk">
        <a href="http://naila.ddns.net/?page=pages/bhs/tim" class="noHover">                <!-- od prije "changelang.php?lang=bhs" -->
            <span <?php if ($language==='bhs' ){?>style="color:#2B2B2B;"
                <?php } ?>>BHS
            </span>
        </a>
        <span style="color:#2B2B2B;">|</span>
        <a href="http://naila.ddns.net/?page=pages/en/team" class="noHover">
