...
<div class="navbar navbarLab navPosition">
    ...
    <div class="nav-content" id="nav-content">
        ...
        <a href="?page=pages/bhs/naseLabaratorije#about">O nama</a>
        <a href="?page=pages/bhs/oprema#3dprint">3D printanje Lab</a>
        <a href="?page=pages/bhs/oprema#electronic">Elektronski Lab</a>
        <a href="https://n00bs.fablab.ba">IT Lab</a>
        <a href="https://bio.fablab.ba/" target="_blank">3d Bio Lab</a>
        <a href="?page=pages/bhs/oprema#drone">Drone Lab</a>
        <a href="?page=pages/bhs/oprema#ar">AR/VR lab</a>
        <a href="?page=pages/bhs/oprema#ai">AI Lab</a>
