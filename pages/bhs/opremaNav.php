<head>
    ...
    <link rel="stylesheet" href="../../stilovi/slider.css">
...
<!-- navigation -->
<div class="navbar navbarLab navPosition">
    <div class="nav-head">
        <img class="homeeLab navLogo" src="../../slike/logo.png">
    ...
    <div class="nav-content" id="nav-content">
        ...
        <a href="?page=pages/bhs/naseLabaratorije#about">Labaratorije</a>
        <a href="?page=pages/bhs/naseLabaratorije#3dprint">3D Print Lab</a>
        <a href="?page=pages/bhs/naseLabaratorije#electronic">Electronic Lab</a>
        <a href="https://n00bs.fablab.ba" target="_blank">IT Lab</a>
        <a href="https://bio.fablab.ba/" target="_blank">3d Bio Lab</a>
        <a href="?page=pages/bhs/naseLabaratorije#droneLab">Drone Lab</a>
        <a href="?page=pages/bhs/naseLabaratorije#arvr">AR/VR lab</a>
        <a href="?page=pages/bhs/naseLabaratorije#ai">AI Lab</a>
        <a href="?page=pages/bhs/oprema">Oprema</a>
        <span class="lanFlags">
