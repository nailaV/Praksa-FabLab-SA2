...
.b { background-image: url("../../slike/fabcity.jpg"); background-repeat: no-repeat;
...
<!-- navigation -->
<div class="navbar navbarInit navPosition">
    <div class="nav-head">
		<img class="homeeI navLogo" src="../../slike/logo.png">
       ...
       <div class="nav-content" id="nav-content">
        ...
        <a href="?page=pages/bhs/fabcity">Fab City</a>
        <a href="https://enable.fablab.ba/" target="_blank">E-Nable</a>
        <a href="https://maker.ba/" target="_blank">Fab Maker</a>
		              <span class="lanFlags">
