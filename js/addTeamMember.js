...
function GetTeamDataCEO() {
    ...
    teamData.forEach((element,indexC) => {
        ...
        `<div class="card">
         ...
         <button class="uredi1"  onclick="OpenForm(${indexC}, '${element.title}')"> &#x270E; </button>
...
function GetTeamDataManager() {
    ...
    teamData.forEach((element,indexM) => {
        ...
        `<div class="card">
         ...
         <button class="uredi2"  onclick="OpenForm(${indexM}, '${element.title}')">&#x270E; </button>
         <div class="profile-picture">
          <img src="${element.image}" alt="Profile Picture">
        </div>
         <div class="info">
...
function GetTeamDataIntern() {
    ...
    teamData.forEach((element,indexI) => {
        ...
        `<div class="card">
         ...
         <button class="uredi3"  onclick="OpenForm(${indexI}, '${element.title}')">&#x270E; </button>
         <div class="profile-picture">
          <img src="${element.image}" alt="Profile Picture">
        </div>
         <div class="info">
